use posh::{
    gl::{
        DefaultFramebuffer, DrawParams, GeometryType, Program, UniformBufferBinding, VertexArray,
    },
...
fn main() {
    ...
    let vertices: VertexArray<MyVertexIface, ()> = todo!();

    program.draw(
        resources,
        vertices.stream_range(0..3, GeometryType::Lines),
        &DefaultFramebuffer,
        &DrawParams::default(),
    );
}
